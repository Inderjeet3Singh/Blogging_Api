...
import SecondApiProject.Blogging_Api.config.AppConstants;
...
public class PostController {
	...
	// to get the data from the url we use requestParam
	// get
//	@GetMapping("/posts")
...
//		
//		List<PostDto> allPostDtos = this.postService.getAllPost(pageNumber,pageSize);
//		
